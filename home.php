...
<?php include "header.php"?>
  ...
  <div class="container">
    <h1 class="text-center" >Data to perform CRUD Operations</h1>
      <a href="includes/create.php" class='btn btn-outline-dark mb-2'> <i class="bi bi-person-plus"></i> Create New User</a>
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <?php
            ...
            while($row= mysqli_fetch_assoc($view_users)){
              ...
              echo " <td class='text-center' > <a href='includes/update.php?edit&user_id={$id}' class='btn btn-secondary'><i class='bi bi-pencil'></i> EDIT</a> </td>";
